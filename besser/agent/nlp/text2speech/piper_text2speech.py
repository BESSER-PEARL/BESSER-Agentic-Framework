...
class PiperText2Speech(Text2Speech):
    ...
    def text2speech(self, text: str) -> dict:
        ...
        try:
            ...
            print(f"Error: Could not connect to the Piper TTS service at {self._piper_api_url}.")
            print("Ensure the Docker container 'piper-service' is running.")
        except requests.exceptions.RequestException as e:
            print(f"Error during API request to Piper TTS service: {e}")
            ...
            try:
                ...
                print("Service Response (raw):", response.text)
