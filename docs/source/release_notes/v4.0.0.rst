...
- Added the :class:`~baf.core.processors.audio_language_detection_processor` class:
...
- NLPEngine.speech2text(): :meth:`baf.nlp.nlp_engine.NLPEngine.speech2text` now requires a Session parameter
